...
export default async function SignupPage({
  ...
  const { role: roleParam, error: errorParam } = await searchParams;
        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-12">
          ...
          <div>
            ...
            <h2 className="text-white text-3xl font-bold leading-snug mb-3">
              {isVendor
                ? "Your store. Your brand. Your link."
                : "Discover the best of Nigerian sellers."}
            </h2>
      ...
      <div className="flex items-center justify-center p-6 sm:p-10 bg-white">
        <div className="w-full max-w-md">
          ...
          <form action={registerUser} className="space-y-5">
            ...
            >
              {isVendor ? "Create seller account" : "Create account"}
            </button>
          </form>
